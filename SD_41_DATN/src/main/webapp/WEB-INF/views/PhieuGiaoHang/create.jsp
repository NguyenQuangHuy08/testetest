...
<%--                        onblur="formatPhiShip()"--%>
<%--                        <frm:input type="text" class="form-control" path="phiShip" cssStyle="" placeholder="Input VNĐ" value=""/>--%>
<%--                        <frm:errors path="phiShip"></frm:errors>--%>

                        <frm:input id="phiShip" required="" type="text" class="form-control" path="phiShip" cssStyle="" placeholder="Input phí ship" value=""/>
                        <frm:errors path="phiShip"></frm:errors>
