...
<div class="container">
    <h3 style="text-align: center; color: black; margin-top: 40px; margin-bottom: 30px">Edit dữ liệu chương trình giảm giá hóa đơn</h3>

    <div class="back" style="margin-bottom: 80px">
        ...
        <div class="row">
            <div class="col-6">
                <div class="group">
                    ...
                    <frm:input  required="" type="text" class="input" path="tenChuongTrinh" cssStyle="width: 450px;" placeholder="Input text" value="${chuongTrinhGiamGiaHoaDon.tenChuongTrinh}"/>
            ...
            <div class="col-6">
                <div class="group">
                    ...
                    <frm:input  required="" type="text" class="input" path="phanTramGiam" cssStyle="width: 450px;" placeholder="Input number" value="${chuongTrinhGiamGiaHoaDon.phanTramGiam}"/>
                    <span class="highlight"></span>
                    <span class="bar"></span>
            ...
            <div class="col-6">
                <div class="group">
                    ...
                    <frm:input  required="" type="text" class="input" path="soLuongSanPham" cssStyle="width: 450px;" placeholder="Input number" value="${chuongTrinhGiamGiaHoaDon.soLuongSanPham}"/>
                    <span class="highlight"></span>
                    <span class="bar"></span>
            ...
            <div class="col-6">
                <div class="group">
                    ...
                    <frm:input  required="" type="text" class="input" path="soTienHoaDon" cssStyle="width: 450px;" placeholder="Input number" value="${chuongTrinhGiamGiaHoaDon.soTienHoaDon}"/>
                    <span class="highlight"></span>
                    <span class="bar"></span>
            ...
            <div class="col-6">
                <div class="group">
                    <frm:input  required="" type="date" class="input" path="ngayBatDau" cssStyle="width: 450px;" placeholder="Input number" value="${chuongTrinhGiamGiaHoaDon.ngayBatDau}"/>
                    <span class="highlight"></span>
                    <span class="bar"></span>
            ...
            <div class="col-6">
                <div class="group">
                    <frm:input  required="" type="date" class="input" path="ngayKetThuc" cssStyle="width: 450px;" placeholder="Input number" value="${chuongTrinhGiamGiaHoaDon.ngayKetThuc}"/>
                    <span class="highlight"></span>
                    <span class="bar"></span>
            ...
            <div class="col-6" style="margin-top: 32px">
                <div class="group">
                    <frm:input  required="" type="text" class="input" path="ghiChu" cssStyle="width: 450px;" placeholder="Input text" value="${chuongTrinhGiamGiaHoaDon.ghiChu}"/>
                    <span class="highlight"></span>
                    <span class="bar"></span>
