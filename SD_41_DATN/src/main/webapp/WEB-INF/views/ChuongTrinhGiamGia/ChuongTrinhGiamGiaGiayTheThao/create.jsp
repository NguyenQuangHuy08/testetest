...
<div class="container">
    <div>
        ...
        <div class="back">
            <a class="col-sm-4" href="${pageContext.request.contextPath}/ChuongTrinhGiamGiaGiayTheThao/list"><button class="btn btn-primary">Back</button></a>
        </div>
            ...
            <div class="row">
                    <div class="col-6">
                        <div class="group">
                            ...
                            <frm:input  required="" type="text" class="input" path="tenChuongTrinhGiamGia" cssStyle="width: 450px;" placeholder="Input text" value=""/>
                    ...
                    <div class="col-6">
                        <div class="group">
                            <frm:input  required="" type="date" class="input" path="ngayBatDau" cssStyle="width: 450px;" value=""/>
                            <span class="highlight"></span>
                            <span class="bar"></span>
                    ...
                    <div class="col-6">
                        <div class="group">
                            <frm:input disabled="false" required="" type="date" class="input" path="ngayKetThuc" cssStyle="width: 450px;" value=""/>
                            <span class="highlight"></span>
                            <span class="bar"></span>
